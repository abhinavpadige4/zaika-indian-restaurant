    ...
    >
      <div className="container mx-auto px-4">
        <h2 
          ...
          aria-label="What our guests say about us"
        >
          What Our Guests Say
        </h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center fade-in">
            ...
            <p 
              className="text-lg italic text-gray-700 mb-6 max-w-xl mx-auto line-clamp-4"
              aria-label={`Review by ${testimonial.name}: ${testimonial.text}`}
            >
              "{testimonial.text}"
            </p>
